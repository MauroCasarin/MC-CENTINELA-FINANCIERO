...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-bg text-white selection:bg-primary/30 font-sans flex flex-col items-center">
          ...
          <div className="logo-container">
            <a href="https://www.instagram.com/3d_mc_3d/" target="_blank" rel="noopener noreferrer">
              <img 
                ...
                alt="MC Logo" 
                className="h-[48px] w-auto cursor-pointer transition-transform duration-200 hover:scale-105"
              />
            </a>
          </div>
      ...
      <main className="w-full max-w-[800px] p-5 space-y-6">
...
function AlertCard({ alert }: { alert: MarketAlert }) {
  ...
  return (
    <div className="bg-card-bg border border-[#222] rounded-[12px] p-[25px] relative overflow-hidden border-l-4 border-l-primary group">
