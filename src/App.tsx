...
export default function App() {
  ...
  async function ejecutarDeepScanIA() {
      ...
      try {
          ...
          const tnaRef = resTasa[resTasa.length - 1].valor || 30;
          const mensualLecap = (tnaRef/12+0.3).toFixed(2);
          
          const oficial = resDolar.find((d: any) => d.casa === 'oficial')?.venta || 1;
          const blue = resDolar.find((d: any) => d.casa === 'blue')?.venta || 1;
  ...
  return (
    <>
      ...
      <div className="ai-terminal">
          ...
          <div className="strategy-grid" style={{gridTemplateColumns: '1fr'}}>
